// CSKY Platform — Sound System
// Extracted from Project Nullframe
...
export const SFX = {
  ...
  armed: [
    { from: 800, to: 1200, decay: 0.08, gain: 0.18 },
    { from: 1200, to: 1600, decay: 0.06, gain: 0.14, delay: 0.06 },
  ],
  warning: [
    { from: 880, decay: 0.12, gain: 0.2 },
    { from: 880, decay: 0.12, gain: 0.2, delay: 0.15 },
  ],
